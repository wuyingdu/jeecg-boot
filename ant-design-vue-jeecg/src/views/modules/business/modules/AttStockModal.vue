  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/business/attStock/add",
          edit: "/business/attStock/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'attId','num','remark'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'attId','num','remark'))
      },
